...
const InteractiveMap = ({ source = "Hyderabad", destination = "Bangalore" }: InteractiveMapProps) => {
  ...
  return (
    <div className="glass-card rounded-[2rem] overflow-hidden h-[400px] relative group shadow-sm">
      {/* Mock Map Background */}
        ...
        <svg className="w-full h-full opacity-40" viewBox="0 0 800 400">
          ...
          <AnimatePresence>
            {isTracking && (
              ...
              >
                <circle r="12" fill="#3b82f6" fillOpacity="0.1" />
        ...
        <div className="flex justify-center">
          <motion.div 
            ...
            className={cn(
              ...
              isTracking ? "bg-emerald-500 text-white shadow-emerald-200" : "bg-primary text-white shadow-primary/20"
            )}
          >
            {isTracking ? (
              <>
